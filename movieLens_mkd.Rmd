...
The final RMSE on the hold-out test set was *0.8673*, slightly above the target benchmark of *0.8649*. Although the threshold was narrowly missed, this performance still reflects solid generalization. Since the hold-out set was not used at any stage of development or tuning, the evaluation remains unbiased. This result suggests the model captures relevant patterns without severely overfitting.

# Conclusion

The model was refined step by step, from a naive average approach to one incorporating both movie and user-specific effects. Exploratory analysis and performance evaluation through RMSE guided the modeling process throughout. While the final result remained just above the target threshold, the overall framework proved effective and interpretable.
